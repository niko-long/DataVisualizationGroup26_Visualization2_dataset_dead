...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file, 181, 0, 5421);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function drawSword(x, y, r) {
    		ctx.beginPath();
    		const handleWidth = r * 0.2;
    		const handleHeight = r * 0.4;
    		const bladeLength = r * 1.2;
    		const bladeWidth = r * 0.3;
    		...
    		ctx.closePath();
    		$$invalidate(11, ctx.fillStyle = scYearColor(years), ctx);
    		ctx.fill();
    	}

    	function drawShield(x, y, r) {
    		ctx.beginPath();
    		const notchRatio = 0.25;
    		const notchDepth = r * notchRatio;
    		const handleWidth = r * 0.15;
    		const handleLength = r * 0.3;
    		ctx.moveTo(x - r, y);
    		ctx.lineTo(x - r + notchDepth, y + notchDepth);
    		ctx.lineTo(x - r + notchDepth, y + r - notchDepth);
    		const numPointsTop = 15;
    		const angleStepTop = Math.PI / numPointsTop;

    		for (let i = 0; i <= numPointsTop; i++) {
    			const angle = i * angleStepTop;
    			const bulge = Math.sin(angle) * r * 0.1;
    	...
    	function draw(width, height, selectedIso) {
    		...
    		years.forEach(year => {
    			...
    			data.forEach(d => {
    				...
    				ctx.beginPath();
    				drawStar(ctx, x, y, scMortRate(yearData.value) * 0.45, 15, scMortRate(yearData.value) * 0.1);
    				ctx.fill();
    			});
    		});
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(stop0, "stop-color", "rgba(200,200,255,0.3)");
    			add_location(stop0, file$1, 11, 4, 303);
    			attr_dev(stop1, "offset", stop1_offset_value = /*scCartPriceInCP*/ ctx[0](0) / /*scCartPriceInCP*/ ctx[0].range()[1]);
    			attr_dev(stop1, "stop-color", "rgba(50, 94, 147,0.4)");
    			add_location(stop1, file$1, 13, 4, 377);
    			attr_dev(stop2, "offset", stop2_offset_value = /*scCartPriceInCP*/ ctx[0](0) / /*scCartPriceInCP*/ ctx[0].range()[1]);
    			attr_dev(stop2, "stop-color", "rgb(0, 44, 97,0.6)");
    			add_location(stop2, file$1, 15, 4, 497);
    			attr_dev(stop3, "offset", "1");
    			attr_dev(stop3, "stop-color", "rgb(0, 44, 97)");
    			add_location(stop3, file$1, 17, 4, 614);
    			attr_dev(radialGradient, "id", "CartPriceInCP-gradient");
    			attr_dev(radialGradient, "gradientUnits", "userSpaceOnUse");
    			attr_dev(radialGradient, "cx", "0");
    			attr_dev(radialGradient, "cy", "0");
    			attr_dev(radialGradient, "r", radialGradient_r_value = /*scCartPriceInCP*/ ctx[0].range()[1]);
    			add_location(radialGradient, file$1, 6, 2, 106);
    			attr_dev(feDropShadow, "dx", "0");
    			attr_dev(feDropShadow, "dy", "0");
    			attr_dev(feDropShadow, "stdDeviation", "100");
    			attr_dev(feDropShadow, "flood-color", "#A6D9F7");
    			add_location(feDropShadow, file$1, 24, 4, 809);
    			attr_dev(filter0, "id", "CartPriceInCP-shadow");
    			add_location(filter0, file$1, 23, 2, 770);
    			attr_dev(feTurbulence0, "type", "fractalNoise");
    			attr_dev(feTurbulence0, "baseFrequency", "0.05");
    			attr_dev(feTurbulence0, "numOctaves", "3");
    			attr_dev(feTurbulence0, "result", "turbulence");
    			add_location(feTurbulence0, file$1, 31, 6, 994);
    			attr_dev(feDisplacementMap0, "in", "SourceGraphic");
    			attr_dev(feDisplacementMap0, "in2", "turbulence");
    			attr_dev(feDisplacementMap0, "scale", "10");
    			add_location(feDisplacementMap0, file$1, 32, 6, 1092);
    			attr_dev(filter1, "id", "turbulence");
    			add_location(filter1, file$1, 30, 2, 963);
    			attr_dev(feTurbulence1, "type", "fractalNoise");
    			attr_dev(feTurbulence1, "baseFrequency", "0.01");
    			attr_dev(feTurbulence1, "numOctaves", "2");
    			attr_dev(feTurbulence1, "result", "turbulence");
    			add_location(feTurbulence1, file$1, 36, 6, 1213);
    			attr_dev(feDisplacementMap1, "in", "SourceGraphic");
    			attr_dev(feDisplacementMap1, "in2", "turbulence");
    			attr_dev(feDisplacementMap1, "scale", "5");
    			add_location(feDisplacementMap1, file$1, 37, 6, 1311);
    			attr_dev(filter2, "id", "backgroundTexture");
    			add_location(filter2, file$1, 35, 2, 1175);
    			add_location(defs, file$1, 4, 0, 50);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(filter0, feDropShadow);
    			append_dev(defs, filter1);
    			append_dev(filter1, feTurbulence0);
    			append_dev(filter1, feDisplacementMap0);
    			append_dev(defs, filter2);
    			append_dev(filter2, feTurbulence1);
    			append_dev(filter2, feDisplacementMap1);
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*scCartPriceInCP*/ 1 && stop1_offset_value !== (stop1_offset_value = /*scCartPriceInCP*/ ctx[0](0) / /*scCartPriceInCP*/ ctx[0].range()[1])) {
    				attr_dev(stop1, "offset", stop1_offset_value);
    			}

    			if (dirty & /*scCartPriceInCP*/ 1 && stop2_offset_value !== (stop2_offset_value = /*scCartPriceInCP*/ ctx[0](0) / /*scCartPriceInCP*/ ctx[0].range()[1])) {
    				attr_dev(stop2, "offset", stop2_offset_value);
    			}

    			if (dirty & /*scCartPriceInCP*/ 1 && radialGradient_r_value !== (radialGradient_r_value = /*scCartPriceInCP*/ ctx[0].range()[1])) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let { scCartPriceInCP } = $$props;
    	const writable_props = ["scCartPriceInCP"];
    	...
    	$$self.$set = $$props => {
    		if ("scCartPriceInCP" in $$props) $$invalidate(0, scCartPriceInCP = $$props.scCartPriceInCP);
    	};

    	$$self.$capture_state = () => {
    		return { scCartPriceInCP };
    	};
    ...
    class Defs extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { scCartPriceInCP: 0 });
    		...
    		if (/*scCartPriceInCP*/ ctx[0] === undefined && !("scCartPriceInCP" in props)) {
    			console.warn("<Defs> was created without expected prop 'scCartPriceInCP'");
    		}
    	}
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g, file$2, 38, 2, 966);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(path0, "class", "Area-arc svelte-1ej8cbv");
    			attr_dev(path0, "d", path0_d_value = /*arc*/ ctx[3](/*d*/ ctx[8]));
    			add_location(path0, file$2, 40, 6, 1046);
    			attr_dev(path1, "class", "Area-label-arc svelte-1ej8cbv");
    			attr_dev(path1, "id", path1_id_value = "Area-label-arc-" + /*d*/ ctx[8].Area);
    			attr_dev(path1, "d", path1_d_value = /*labelArc*/ ctx[4](/*d*/ ctx[8]));
    			add_location(path1, file$2, 41, 6, 1094);
    			attr_dev(textPath, "class", "Area-label svelte-1ej8cbv");
    			attr_dev(textPath, "href", textPath_href_value = "#Area-label-arc-" + /*d*/ ctx[8].Area);
    			attr_dev(textPath, "startOffset", "25%");
    			add_location(textPath, file$2, 43, 8, 1197);
    			add_location(text_1, file$2, 42, 6, 1182);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*data*/ 4 && path1_id_value !== (path1_id_value = "Area-label-arc-" + /*d*/ ctx[8].Area)) {
    			...
    			if (dirty & /*data*/ 4 && t_value !== (t_value = /*d*/ ctx[8].Area + "")) set_data_dev(t, t_value);

    			if (dirty & /*data*/ 4 && textPath_href_value !== (textPath_href_value = "#Area-label-arc-" + /*d*/ ctx[8].Area)) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function defineArcs() {
    		...
    		$$invalidate(3, arc = d3arc().startAngle(d => d.startAngle).endAngle(d => d.endAngle).innerRadius(innerAreaRadius).outerRadius(innerAreaRadius * lineThicknessFactor).cornerRadius(7));
    		$$invalidate(4, labelArc = d3arc().startAngle(d => d.startAngle).endAngle(d => d.endAngle).innerRadius(innerAreaRadius * labelOffsetFactor).outerRadius(innerAreaRadius * labelOffsetFactor));
    	}

    	const writable_props = ["width", "height", "data", "years", "scYearRadius"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Continents> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("years" in $$props) $$invalidate(5, years = $$props.years);
    		if ("scYearRadius" in $$props) $$invalidate(6, scYearRadius = $$props.scYearRadius);
    		if ("arc" in $$props) $$invalidate(3, arc = $$props.arc);
    	...
    	return [width, height, data, arc, labelArc, years, scYearRadius];
    }
    ...
    class Continents extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*width*/ ctx[0] === undefined && !("width" in props)) {
    			console_1.warn("<Continents> was created without expected prop 'width'");
    		}

    		if (/*height*/ ctx[1] === undefined && !("height" in props)) {
    			console_1.warn("<Continents> was created without expected prop 'height'");
    		}

    		if (/*data*/ ctx[2] === undefined && !("data" in props)) {
    			console_1.warn("<Continents> was created without expected prop 'data'");
    		}

    		if (/*years*/ ctx[5] === undefined && !("years" in props)) {
    			console_1.warn("<Continents> was created without expected prop 'years'");
    		}

    		if (/*scYearRadius*/ ctx[6] === undefined && !("scYearRadius" in props)) {
    			console_1.warn("<Continents> was created without expected prop 'scYearRadius'");
    		}
    	}
    ...
    /* src/flower/CartPriceInCP.svelte generated by Svelte v3.16.7 */
    const file$3 = "src/flower/CartPriceInCP.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(circle, "r", circle_r_value = /*scCartPriceInCP*/ ctx[3](0));
    			attr_dev(circle, "stroke", "rgb(0, 44, 97, 0.5)");
    			attr_dev(circle, "stroke-width", "20");
    			attr_dev(circle, "stroke-dasharray", "2,10");
    			attr_dev(circle, "fill", "none");
    			add_location(circle, file$3, 24, 2, 915);
    			attr_dev(path_1, "d", path_1_d_value = /*path*/ ctx[4](/*data*/ ctx[2]));
    			attr_dev(path_1, "stroke", "rgba(0, 44, 97,0.5)");
    			attr_dev(path_1, "fill", "url(#CartPriceInCP-gradient)");
    			add_location(path_1, file$3, 32, 2, 1114);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 2 + " " + /*height*/ ctx[1] / 2 + ")");
    			add_location(g, file$3, 23, 0, 861);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*scCartPriceInCP*/ 8 && circle_r_value !== (circle_r_value = /*scCartPriceInCP*/ ctx[3](0))) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<CartPriceInCP> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$set = $$props => {
    		...
    		if ("scCartPriceInCP" in $$props) $$invalidate(3, scCartPriceInCP = $$props.scCartPriceInCP);
    		if ("scDeliveryTimeCost" in $$props) $$invalidate(6, scDeliveryTimeCost = $$props.scDeliveryTimeCost);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*scCountryAngle, scCartPriceInCP*/ 40) {
    			 $$invalidate(4, path = lineRadial$1().angle(d => scCountryAngle(d.Territory)).radius(d => scCartPriceInCP(d.CartPriceInCP)).curve(curveCardinal));
    		}

    		if ($$self.$$.dirty & /*scCountryAngle, scDeliveryTimeCost*/ 96) {
    			 path2 = lineRadial$1().angle(d => scCountryAngle(d.Territory)).radius(d => scDeliveryTimeCost(d.DeliveryTimeCost)).curve(curveCardinal);
    		}
    	};

    	return [width, height, data, scCartPriceInCP, path, scCountryAngle, scDeliveryTimeCost];
    }

    class CartPriceInCP extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, {
    			...
    			scCountryAngle: 5,
    			scCartPriceInCP: 3,
    			scDeliveryTimeCost: 6
    		});

    		dispatch_dev("SvelteRegisterComponent", {
    			component: this,
    			tagName: "CartPriceInCP",
    			options,
    			id: create_fragment$3.name
    		});
    		...
    		if (/*width*/ ctx[0] === undefined && !("width" in props)) {
    			console.warn("<CartPriceInCP> was created without expected prop 'width'");
    		}

    		if (/*height*/ ctx[1] === undefined && !("height" in props)) {
    			console.warn("<CartPriceInCP> was created without expected prop 'height'");
    		}

    		if (/*data*/ ctx[2] === undefined && !("data" in props)) {
    			console.warn("<CartPriceInCP> was created without expected prop 'data'");
    		}

    		if (/*scCountryAngle*/ ctx[5] === undefined && !("scCountryAngle" in props)) {
    			console.warn("<CartPriceInCP> was created without expected prop 'scCountryAngle'");
    		}

    		if (/*scCartPriceInCP*/ ctx[3] === undefined && !("scCartPriceInCP" in props)) {
    			console.warn("<CartPriceInCP> was created without expected prop 'scCartPriceInCP'");
    		}

    		if (/*scDeliveryTimeCost*/ ctx[6] === undefined && !("scDeliveryTimeCost" in props)) {
    			console.warn("<CartPriceInCP> was created without expected prop 'scDeliveryTimeCost'");
    		}
    	}

    	get width() {
    		throw new Error("<CartPriceInCP>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set width(value) {
    		throw new Error("<CartPriceInCP>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    	...
    	get scDeliveryTimeCost() {
    		throw new Error("<CartPriceInCP>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set scDeliveryTimeCost(value) {
    		throw new Error("<CartPriceInCP>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const cartpriceincppath = new CartPriceInCP({
    			props: {
    				width: /*width*/ ctx[0],
    				height: /*height*/ ctx[1],
    				data: /*data*/ ctx[3],
    				scCountryAngle: /*scCountryAngle*/ ctx[5],
    				scCartPriceInCP: /*scCartPriceInCP*/ ctx[7],
    				scDeliveryTimeCost: /*scDeliveryTimeCost*/ ctx[8]
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			svg = svg_element("svg");
    			create_component(cartpriceincppath.$$.fragment);
    			create_component(continents.$$.fragment);
    			attr_dev(svg, "class", "svg-visual svelte-dgqppg");
    			attr_dev(svg, "width", /*width*/ ctx[0]);
    			attr_dev(svg, "height", /*height*/ ctx[1]);
    			set_style(svg, "margin", /*offset*/ ctx[2] / 2 + "px");
    			add_location(svg, file$4, 51, 0, 1685);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(cartpriceincppath, svg, null);
    			mount_component(continents, svg, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			const cartpriceincppath_changes = {};
    			if (dirty & /*width*/ 1) cartpriceincppath_changes.width = /*width*/ ctx[0];
    			if (dirty & /*height*/ 2) cartpriceincppath_changes.height = /*height*/ ctx[1];
    			if (dirty & /*data*/ 8) cartpriceincppath_changes.data = /*data*/ ctx[3];
    			if (dirty & /*scCountryAngle*/ 32) cartpriceincppath_changes.scCountryAngle = /*scCountryAngle*/ ctx[5];
    			if (dirty & /*scCartPriceInCP*/ 128) cartpriceincppath_changes.scCartPriceInCP = /*scCartPriceInCP*/ ctx[7];
    			if (dirty & /*scDeliveryTimeCost*/ 256) cartpriceincppath_changes.scDeliveryTimeCost = /*scDeliveryTimeCost*/ ctx[8];
    			cartpriceincppath.$set(cartpriceincppath_changes);
    			...
    			if (dirty & /*areasData*/ 512) continents_changes.data = /*areasData*/ ctx[9];
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(cartpriceincppath.$$.fragment, local);
    			transition_in(continents.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(cartpriceincppath.$$.fragment, local);
    			transition_out(continents.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(svg);
    			destroy_component(cartpriceincppath);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function loadAreasData() {
    		...
    		$$invalidate(9, areasData = uniqueAreas.map(Area => {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<SVGVisualBelow> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$set = $$props => {
    		...
    		if ("scCountryAngle" in $$props) $$invalidate(5, scCountryAngle = $$props.scCountryAngle);
    		if ("scYearRadius" in $$props) $$invalidate(6, scYearRadius = $$props.scYearRadius);
    		if ("scCartPriceInCP" in $$props) $$invalidate(7, scCartPriceInCP = $$props.scCartPriceInCP);
    		if ("scDeliveryTimeCost" in $$props) $$invalidate(8, scDeliveryTimeCost = $$props.scDeliveryTimeCost);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("scCartPriceInCP" in $$props) $$invalidate(7, scCartPriceInCP = $$props.scCartPriceInCP);
    		if ("scDeliveryTimeCost" in $$props) $$invalidate(8, scDeliveryTimeCost = $$props.scDeliveryTimeCost);
    		if ("areasData" in $$props) $$invalidate(9, areasData = $$props.areasData);
    	};
    ...
    class SVGVisualBelow extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*width*/ ctx[0] === undefined && !("width" in props)) {
    			console_1$1.warn("<SVGVisualBelow> was created without expected prop 'width'");
    		}

    		if (/*height*/ ctx[1] === undefined && !("height" in props)) {
    			console_1$1.warn("<SVGVisualBelow> was created without expected prop 'height'");
    		}

    		if (/*offset*/ ctx[2] === undefined && !("offset" in props)) {
    			console_1$1.warn("<SVGVisualBelow> was created without expected prop 'offset'");
    		}

    		if (/*data*/ ctx[3] === undefined && !("data" in props)) {
    			console_1$1.warn("<SVGVisualBelow> was created without expected prop 'data'");
    		}

    		if (/*years*/ ctx[4] === undefined && !("years" in props)) {
    			console_1$1.warn("<SVGVisualBelow> was created without expected prop 'years'");
    		}

    		if (/*scCountryAngle*/ ctx[5] === undefined && !("scCountryAngle" in props)) {
    			console_1$1.warn("<SVGVisualBelow> was created without expected prop 'scCountryAngle'");
    		}

    		if (/*scYearRadius*/ ctx[6] === undefined && !("scYearRadius" in props)) {
    			console_1$1.warn("<SVGVisualBelow> was created without expected prop 'scYearRadius'");
    		}

    		if (/*scCartPriceInCP*/ ctx[7] === undefined && !("scCartPriceInCP" in props)) {
    			console_1$1.warn("<SVGVisualBelow> was created without expected prop 'scCartPriceInCP'");
    		}

    		if (/*scDeliveryTimeCost*/ ctx[8] === undefined && !("scDeliveryTimeCost" in props)) {
    			console_1$1.warn("<SVGVisualBelow> was created without expected prop 'scDeliveryTimeCost'");
    		}
    	}
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			text_1 = svg_element("text");
    			t = text(t_value);
    			attr_dev(text_1, "transform", text_1_transform_value = "translate(0 " + (-/*scYearRadius*/ ctx[3](/*year*/ ctx[4]) + Math.min(/*width*/ ctx[0], /*height*/ ctx[1]) / 40) + ")");
    			attr_dev(text_1, "class", "svelte-7kdziz");
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*scYearRadius, years, width, height*/ 15 && text_1_transform_value !== (text_1_transform_value = "translate(0 " + (-/*scYearRadius*/ ctx[3](/*year*/ ctx[4]) + Math.min(/*width*/ ctx[0], /*height*/ ctx[1]) / 40) + ")")) {
    ...
    function create_if_block_3(ctx) {
    	...
    	let g_transform_value;
    	let each_value_3 = /*yLabels*/ ctx[11];
    	let each_blocks_1 = [];
    	...
    	let each_value_2 = /*xScale*/ ctx[6].domain();
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text("Sales Per Territory");
    			text1 = svg_element("text");
    			t1 = text("From 2019 to 2023");
    			...
    			attr_dev(circle, "cx", "0");
    			attr_dev(circle, "cy", "0");
    			attr_dev(circle, "r", "240");
    			attr_dev(circle, "stroke", "#4682B4");
    			attr_dev(circle, "stroke-width", "15");
    			attr_dev(circle, "stroke-dasharray", "2,10");
    			attr_dev(circle, "fill", "white");
    			attr_dev(circle, "fill-opacity", "0.6");
    			add_location(circle, file$6, 113, 4, 3866);
    			attr_dev(text0, "class", "title svelte-10mb060");
    			attr_dev(text0, "transform", text0_transform_value = "translate(0 " + /*yScale*/ ctx[7].range()[1] * 1.4 + ")");
    			add_location(text0, file$6, 119, 4, 4020);
    			attr_dev(text1, "class", "titlesmall svelte-10mb060");
    			attr_dev(text1, "transform", text1_transform_value = "translate(0 " + /*yScale*/ ctx[7].range()[1] * 1.1 + ")");
    			add_location(text1, file$6, 121, 4, 4132);
    			attr_dev(path, "d", path_d_value = /*line*/ ctx[9](/*dataArr*/ ctx[4]));
    			attr_dev(path, "stroke", "orange");
    			attr_dev(path, "stroke-width", "5");
    			attr_dev(path, "fill", "none");
    			add_location(path, file$6, 123, 4, 4247);
    			attr_dev(text2, "class", "price-label svelte-10mb060");
    			attr_dev(text2, "transform", text2_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1.25 + " " + /*yScale*/ ctx[7].range()[1] * 0.15 + ")");
    			add_location(text2, file$6, 132, 4, 4550);
    			attr_dev(line_1, "x1", line_1_x__value = /*xScale*/ ctx[6].range()[0]);
    			attr_dev(line_1, "y1", line_1_y__value = /*yScale*/ ctx[7].range()[0]);
    			attr_dev(line_1, "x2", line_1_x__value_1 = /*xScale*/ ctx[6].range()[1]);
    			attr_dev(line_1, "y2", line_1_y__value_1 = /*yScale*/ ctx[7].range()[0]);
    			attr_dev(line_1, "class", "svelte-10mb060");
    			add_location(line_1, file$6, 134, 4, 4683);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 2 + " " + /*height*/ ctx[1] / 2 + ")");
    			add_location(g, file$6, 112, 2, 3810);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, circle);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*yScale*/ 128 && text0_transform_value !== (text0_transform_value = "translate(0 " + /*yScale*/ ctx[7].range()[1] * 1.4 + ")")) {
    				attr_dev(text0, "transform", text0_transform_value);
    			}

    			if (dirty[0] & /*yScale*/ 128 && text1_transform_value !== (text1_transform_value = "translate(0 " + /*yScale*/ ctx[7].range()[1] * 1.1 + ")")) {
    				attr_dev(text1, "transform", text1_transform_value);
    			}

    			if (dirty[0] & /*line, dataArr*/ 528 && path_d_value !== (path_d_value = /*line*/ ctx[9](/*dataArr*/ ctx[4]))) {
    				attr_dev(path, "d", path_d_value);
    			}

    			if (dirty[0] & /*yLabels*/ 2048) {
    				each_value_3 = /*yLabels*/ ctx[11];
    				let i;
    			...
    			if (dirty[0] & /*xScale, yScale*/ 192 && text2_transform_value !== (text2_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1.25 + " " + /*yScale*/ ctx[7].range()[1] * 0.15 + ")")) {
    				attr_dev(text2, "transform", text2_transform_value);
    			}

    			if (dirty[0] & /*xScale*/ 64 && line_1_x__value !== (line_1_x__value = /*xScale*/ ctx[6].range()[0])) {
    				attr_dev(line_1, "x1", line_1_x__value);
    			}

    			if (dirty[0] & /*yScale*/ 128 && line_1_y__value !== (line_1_y__value = /*yScale*/ ctx[7].range()[0])) {
    				attr_dev(line_1, "y1", line_1_y__value);
    			}

    			if (dirty[0] & /*xScale*/ 64 && line_1_x__value_1 !== (line_1_x__value_1 = /*xScale*/ ctx[6].range()[1])) {
    				attr_dev(line_1, "x2", line_1_x__value_1);
    			}

    			if (dirty[0] & /*yScale*/ 128 && line_1_y__value_1 !== (line_1_y__value_1 = /*yScale*/ ctx[7].range()[0])) {
    				attr_dev(line_1, "y2", line_1_y__value_1);
    			}

    			if (dirty[0] & /*xScale, yScale*/ 192) {
    				each_value_2 = /*xScale*/ ctx[6].domain();
    				let i;
    			...
    			if (dirty[0] & /*width, height*/ 3 && g_transform_value !== (g_transform_value = "translate(" + /*width*/ ctx[0] / 2 + " " + /*height*/ ctx[1] / 2 + ")")) {
    				attr_dev(g, "transform", g_transform_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(111:0) {#if (data && selectedIso)}",
    		ctx
    	});
    ...
    // (128:4) {#each yLabels as yLabel}
    function create_each_block_3(ctx) {
    	let text_1;
    	let t_value = /*yLabel*/ ctx[27].text + "";
    	let t;
    	let text_1_transform_value;
    	...
    	const block = {
    		c: function create() {
    			text_1 = svg_element("text");
    			t = text(t_value);
    			attr_dev(text_1, "class", "y-label svelte-10mb060");
    			attr_dev(text_1, "transform", text_1_transform_value = "translate(" + /*yLabel*/ ctx[27].x + " " + /*yLabel*/ ctx[27].y + ")");
    			attr_dev(text_1, "text-anchor", text_1_text_anchor_value = /*yLabel*/ ctx[27].textAnchor);
    			add_location(text_1, file$6, 128, 6, 4390);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, text_1, anchor);
    			append_dev(text_1, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*yLabels*/ 2048 && t_value !== (t_value = /*yLabel*/ ctx[27].text + "")) set_data_dev(t, t_value);

    			if (dirty[0] & /*yLabels*/ 2048 && text_1_transform_value !== (text_1_transform_value = "translate(" + /*yLabel*/ ctx[27].x + " " + /*yLabel*/ ctx[27].y + ")")) {
    				attr_dev(text_1, "transform", text_1_transform_value);
    			}

    			if (dirty[0] & /*yLabels*/ 2048 && text_1_text_anchor_value !== (text_1_text_anchor_value = /*yLabel*/ ctx[27].textAnchor)) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(128:4) {#each yLabels as yLabel}",
    		ctx
    	});
    ...
    // (139:4) {#each xScale.domain() as xLabel, i}
    function create_each_block_2(ctx) {
    	let text_1;
    	let t_value = /*xLabel*/ ctx[24] + "";
    	let t;
    	let text_1_transform_value;
    	let text_1_text_anchor_value;
    	...
    	const block = {
    		c: function create() {
    			text_1 = svg_element("text");
    			t = text(t_value);
    			attr_dev(text_1, "class", "x-label svelte-10mb060");
    			attr_dev(text_1, "transform", text_1_transform_value = "translate(" + /*xScale*/ ctx[6](/*xLabel*/ ctx[24]) + " " + /*yScale*/ ctx[7].range()[0] * 1.25 + ")");
    			attr_dev(text_1, "text-anchor", text_1_text_anchor_value = /*i*/ ctx[26] % 2 === 0 ? "start" : "end");
    			add_location(text_1, file$6, 139, 6, 4866);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, text_1, anchor);
    			append_dev(text_1, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*xScale*/ 64 && t_value !== (t_value = /*xLabel*/ ctx[24] + "")) set_data_dev(t, t_value);

    			if (dirty[0] & /*xScale, yScale*/ 192 && text_1_transform_value !== (text_1_transform_value = "translate(" + /*xScale*/ ctx[6](/*xLabel*/ ctx[24]) + " " + /*yScale*/ ctx[7].range()[0] * 1.25 + ")")) {
    				attr_dev(text_1, "transform", text_1_transform_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(139:4) {#each xScale.domain() as xLabel, i}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	let line_1_y__value_1;
    	let g_transform_value;
    	let each_value_1 = /*yLabels2*/ ctx[12];
    	let each_blocks_1 = [];
    	...
    	let each_value = /*xScale*/ ctx[6].domain();
    	let each_blocks = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			circle = svg_element("circle");
    			text0 = svg_element("text");
    			t0 = text("Delivery Time Cost");
    			text1 = svg_element("text");
    			t1 = text("Per Territory");
    			path = svg_element("path");
    			...
    			attr_dev(circle, "cx", "0");
    			attr_dev(circle, "cy", "0");
    			attr_dev(circle, "r", "260");
    			attr_dev(circle, "stroke", "#4682B4");
    			attr_dev(circle, "stroke-width", "20");
    			attr_dev(circle, "stroke-dasharray", "2,10");
    			attr_dev(circle, "fill", "white");
    			attr_dev(circle, "fill-opacity", "0.6");
    			add_location(circle, file$6, 150, 4, 5247);
    			attr_dev(text0, "class", "title2 svelte-10mb060");
    			attr_dev(text0, "transform", text0_transform_value = "translate(0 " + /*yScale2*/ ctx[8].range()[1] * 1.4 + ")");
    			add_location(text0, file$6, 156, 4, 5405);
    			attr_dev(text1, "class", "titlesmall2 svelte-10mb060");
    			attr_dev(text1, "transform", text1_transform_value = "translate(0 " + /*yScale2*/ ctx[8].range()[1] * 1.1 + ")");
    			add_location(text1, file$6, 158, 4, 5518);
    			attr_dev(path, "d", path_d_value = /*line2*/ ctx[10](/*dataArr2*/ ctx[5]));
    			attr_dev(path, "stroke", "orange");
    			attr_dev(path, "stroke-width", "5");
    			attr_dev(path, "fill", "none");
    			add_location(path, file$6, 160, 4, 5632);
    			attr_dev(text2, "class", "price-label2 svelte-10mb060");
    			attr_dev(text2, "transform", text2_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1.25 + " " + /*yScale*/ ctx[7].range()[1] * 0.15 + ")");
    			add_location(text2, file$6, 169, 4, 5939);
    			attr_dev(line_1, "x1", line_1_x__value = /*xScale*/ ctx[6].range()[0]);
    			attr_dev(line_1, "y1", line_1_y__value = /*yScale*/ ctx[7].range()[0]);
    			attr_dev(line_1, "x2", line_1_x__value_1 = /*xScale*/ ctx[6].range()[1]);
    			attr_dev(line_1, "y2", line_1_y__value_1 = /*yScale*/ ctx[7].range()[0]);
    			attr_dev(line_1, "class", "svelte-10mb060");
    			add_location(line_1, file$6, 171, 4, 6068);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 1.2 + " " + /*height*/ ctx[1] / 4 + ")");
    			add_location(g, file$6, 149, 2, 5189);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, circle);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*yScale2*/ 256 && text0_transform_value !== (text0_transform_value = "translate(0 " + /*yScale2*/ ctx[8].range()[1] * 1.4 + ")")) {
    				attr_dev(text0, "transform", text0_transform_value);
    			}

    			if (dirty[0] & /*yScale2*/ 256 && text1_transform_value !== (text1_transform_value = "translate(0 " + /*yScale2*/ ctx[8].range()[1] * 1.1 + ")")) {
    				attr_dev(text1, "transform", text1_transform_value);
    			}

    			if (dirty[0] & /*line2, dataArr2*/ 1056 && path_d_value !== (path_d_value = /*line2*/ ctx[10](/*dataArr2*/ ctx[5]))) {
    				attr_dev(path, "d", path_d_value);
    			}

    			if (dirty[0] & /*yLabels2*/ 4096) {
    				each_value_1 = /*yLabels2*/ ctx[12];
    				let i;
    			...
    			if (dirty[0] & /*xScale, yScale*/ 192) {
    				each_value = /*xScale*/ ctx[6].domain();
    				let i;
    			...
    			if (dirty[0] & /*width, height*/ 3 && g_transform_value !== (g_transform_value = "translate(" + /*width*/ ctx[0] / 1.2 + " " + /*height*/ ctx[1] / 4 + ")")) {
    				attr_dev(g, "transform", g_transform_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(147:0) {#if (data && selectedIso)}",
    		ctx
    	});
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			text_1 = svg_element("text");
    			t = text(t_value);
    			attr_dev(text_1, "class", "y-label2 svelte-10mb060");
    			attr_dev(text_1, "transform", text_1_transform_value = "translate(" + /*yLabel*/ ctx[27].x + " " + /*yLabel*/ ctx[27].y + ")");
    			attr_dev(text_1, "text-anchor", text_1_text_anchor_value = /*yLabel*/ ctx[27].textAnchor);
    			add_location(text_1, file$6, 165, 6, 5778);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, text_1, anchor);
    			append_dev(text_1, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*yLabels2*/ 4096 && t_value !== (t_value = /*yLabel*/ ctx[27].text + "")) set_data_dev(t, t_value);

    			if (dirty[0] & /*yLabels2*/ 4096 && text_1_transform_value !== (text_1_transform_value = "translate(" + /*yLabel*/ ctx[27].x + " " + /*yLabel*/ ctx[27].y + ")")) {
    				attr_dev(text_1, "transform", text_1_transform_value);
    			}

    			if (dirty[0] & /*yLabels2*/ 4096 && text_1_text_anchor_value !== (text_1_text_anchor_value = /*yLabel*/ ctx[27].textAnchor)) {
    				attr_dev(text_1, "text-anchor", text_1_text_anchor_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(165:4) {#each yLabels2 as yLabel}",
    		ctx
    	});
    ...
    // (176:4) {#each xScale.domain() as xLabel, i}
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			text_1 = svg_element("text");
    			t = text(t_value);
    			attr_dev(text_1, "class", "x-label2 svelte-10mb060");
    			attr_dev(text_1, "transform", text_1_transform_value = "translate(" + /*xScale*/ ctx[6](/*xLabel*/ ctx[24]) + " " + /*yScale*/ ctx[7].range()[0] * 1.25 + ")");
    			attr_dev(text_1, "text-anchor", text_1_text_anchor_value = /*i*/ ctx[26] % 2 === 0 ? "start" : "end");
    			add_location(text_1, file$6, 176, 6, 6251);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, text_1, anchor);
    			append_dev(text_1, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(176:4) {#each xScale.domain() as xLabel, i}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	let text_1_transform_value;
    	let g_transform_value;
    	let if_block = /*CartPriceInCP*/ ctx[14] !== undefined && /*AccountNum*/ ctx[15] !== undefined && /*Area*/ ctx[16] !== undefined && /*Product*/ ctx[17] !== undefined && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text("DETAILS");
    			if (if_block) if_block.c();
    			attr_dev(image, "href", "/HowToRead.png");
    			attr_dev(image, "x", "1");
    			attr_dev(image, "y", "200");
    			attr_dev(image, "height", "1000");
    			attr_dev(image, "width", "1000");
    			add_location(image, file$6, 184, 2, 6481);
    			attr_dev(circle, "cx", "0");
    			attr_dev(circle, "cy", "0");
    			attr_dev(circle, "r", "260");
    			attr_dev(circle, "stroke", "#4682B4");
    			attr_dev(circle, "stroke-width", "20");
    			attr_dev(circle, "stroke-dasharray", "2,10");
    			attr_dev(circle, "fill", "rgb(255,255,255)");
    			attr_dev(circle, "fill-opacity", "0.5");
    			add_location(circle, file$6, 189, 4, 6716);
    			attr_dev(text_1, "class", "detailsLarge svelte-10mb060");
    			attr_dev(text_1, "transform", text_1_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -0.5 + " " + /*yScale2*/ ctx[8].range()[1] * 1.4 + ")");
    			add_location(text_1, file$6, 195, 4, 6885);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 1.15 + " " + /*height*/ ctx[1] / 1.45 + ")");
    			add_location(g, file$6, 188, 2, 6654);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*xScale, yScale2*/ 320 && text_1_transform_value !== (text_1_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -0.5 + " " + /*yScale2*/ ctx[8].range()[1] * 1.4 + ")")) {
    				attr_dev(text_1, "transform", text_1_transform_value);
    			}

    			if (/*CartPriceInCP*/ ctx[14] !== undefined && /*AccountNum*/ ctx[15] !== undefined && /*Area*/ ctx[16] !== undefined && /*Product*/ ctx[17] !== undefined) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    			...
    			if (dirty[0] & /*width, height*/ 3 && g_transform_value !== (g_transform_value = "translate(" + /*width*/ ctx[0] / 1.15 + " " + /*height*/ ctx[1] / 1.45 + ")")) {
    				attr_dev(g, "transform", g_transform_value);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(184:0) {#if (data && selectedIso)}",
    		ctx
    	});
    ...
    // (197:6) {#if CartPriceInCP !== undefined && AccountNum !== undefined && Area !== undefined && Product !== undefined}
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			text0 = svg_element("text");
    			t0 = text("Territory Name: ");
    			t1 = text(/*Territory*/ ctx[13]);
    			text1 = svg_element("text");
    			t2 = text("Total Sales(InCP): ");
    			t3 = text(/*CartPriceInCP*/ ctx[14]);
    			text2 = svg_element("text");
    			t4 = text("Costumer Number: ");
    			t5 = text(/*AccountNum*/ ctx[15]);
    			text3 = svg_element("text");
    			t6 = text("Belong to Area: ");
    			t7 = text(/*Area*/ ctx[16]);
    			text4 = svg_element("text");
    			t8 = text("TOP Product: ");
    			t9 = text(/*Product*/ ctx[17]);
    			attr_dev(text0, "class", "details svelte-10mb060");
    			attr_dev(text0, "transform", text0_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * 0.7 + ")");
    			add_location(text0, file$6, 197, 6, 7127);
    			attr_dev(text1, "class", "details svelte-10mb060");
    			attr_dev(text1, "transform", text1_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * 0.3 + ")");
    			add_location(text1, file$6, 198, 6, 7267);
    			attr_dev(text2, "class", "details svelte-10mb060");
    			attr_dev(text2, "transform", text2_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * -0.1 + ")");
    			add_location(text2, file$6, 199, 6, 7414);
    			attr_dev(text3, "class", "details svelte-10mb060");
    			attr_dev(text3, "transform", text3_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * -0.5 + ")");
    			add_location(text3, file$6, 200, 6, 7557);
    			attr_dev(text4, "class", "details svelte-10mb060");
    			attr_dev(text4, "transform", text4_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * -0.9 + ")");
    			add_location(text4, file$6, 201, 6, 7693);
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(text3, t6);
    			append_dev(text3, t7);
    			insert_dev(target, text4, anchor);
    			append_dev(text4, t8);
    			append_dev(text4, t9);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*Territory*/ 8192) set_data_dev(t1, /*Territory*/ ctx[13]);

    			if (dirty[0] & /*xScale, yScale2*/ 320 && text0_transform_value !== (text0_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * 0.7 + ")")) {
    				attr_dev(text0, "transform", text0_transform_value);
    			}

    			if (dirty[0] & /*CartPriceInCP*/ 16384) set_data_dev(t3, /*CartPriceInCP*/ ctx[14]);

    			if (dirty[0] & /*xScale, yScale2*/ 320 && text1_transform_value !== (text1_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * 0.3 + ")")) {
    				attr_dev(text1, "transform", text1_transform_value);
    			}

    			if (dirty[0] & /*AccountNum*/ 32768) set_data_dev(t5, /*AccountNum*/ ctx[15]);

    			if (dirty[0] & /*xScale, yScale2*/ 320 && text2_transform_value !== (text2_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * -0.1 + ")")) {
    				attr_dev(text2, "transform", text2_transform_value);
    			}

    			if (dirty[0] & /*Area*/ 65536) set_data_dev(t7, /*Area*/ ctx[16]);

    			if (dirty[0] & /*xScale, yScale2*/ 320 && text3_transform_value !== (text3_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * -0.5 + ")")) {
    				attr_dev(text3, "transform", text3_transform_value);
    			}

    			if (dirty[0] & /*Product*/ 131072) set_data_dev(t9, /*Product*/ ctx[17]);

    			if (dirty[0] & /*xScale, yScale2*/ 320 && text4_transform_value !== (text4_transform_value = "translate(" + /*xScale*/ ctx[6].range()[1] * -1 + " " + /*yScale2*/ ctx[8].range()[1] * -0.9 + ")")) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(197:6) {#if CartPriceInCP !== undefined && AccountNum !== undefined && Area !== undefined && Product !== undefined}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	let if_block0 = /*data*/ ctx[2] && /*selectedIso*/ ctx[3] && create_if_block_3(ctx);
    	let if_block1 = /*data*/ ctx[2] && /*selectedIso*/ ctx[3] && create_if_block_2(ctx);
    	let if_block2 = /*data*/ ctx[2] && /*selectedIso*/ ctx[3] && create_if_block$1(ctx);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	function updateScalesAndGenerators(radius) {
    		$$invalidate(6, xScale = linear$1().domain(extent([].concat(...data.map(d => d.dataArr)).map(d => d.year))).range([-radius / 1.5, radius / 1.5]));
    		$$invalidate(7, yScale = linear$1().domain([-10, max([].concat(...data.map(d => d.dataArr)).map(d => d.value))]).range([radius / 2, -radius / 2]));
    		$$invalidate(9, line = d3line().x(d => xScale(d.year)).y(d => yScale(d.value)).curve(curveCardinal));

    		$$invalidate(11, yLabels = [
    			{
    	...
    	function updateScalesAndGenerators2(radius) {
    		xScale2 = linear$1().domain(extent([].concat(...data.map(d => d.dataArr2)).map(d => d.year))).range([-radius / 1.5, radius / 1.5]);
    		$$invalidate(8, yScale2 = linear$1().domain([-10, max([].concat(...data.map(d => d.dataArr2)).map(d => d.value))]).range([radius / 2, -radius / 2]));
    		$$invalidate(10, line2 = d3line().x(d => xScale2(d.year)).y(d => yScale2(d.value)).curve(curveCardinal));

    		$$invalidate(12, yLabels2 = [
    			{
    		...
    		if (selectedData) {
    			$$invalidate(14, CartPriceInCP = selectedData.CartPriceInCP);
    			$$invalidate(15, AccountNum = selectedData.AccountNum);
    			$$invalidate(16, Area = selectedData.Area);
    			$$invalidate(17, Product = selectedData.Product);
    			Quantities = selectedData.Quantities;
    			$$invalidate(13, Territory = selectedData.Territory);
    			console.log("CartPriceInCP:", CartPriceInCP);
    			console.log("AccountNum:", AccountNum);
    			console.log("Area:", Area);
    			console.log("Product:", Product);
    		} else {
    			$$invalidate(14, CartPriceInCP = $$invalidate(15, AccountNum = $$invalidate(16, Area = $$invalidate(17, Product = undefined))));
    		}
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<CentralLineChart> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("dataArr2" in $$props) $$invalidate(5, dataArr2 = $$props.dataArr2);
    		if ("xScale" in $$props) $$invalidate(6, xScale = $$props.xScale);
    		if ("xScale2" in $$props) xScale2 = $$props.xScale2;
    		if ("yScale" in $$props) $$invalidate(7, yScale = $$props.yScale);
    		if ("yScale2" in $$props) $$invalidate(8, yScale2 = $$props.yScale2);
    		if ("line" in $$props) $$invalidate(9, line = $$props.line);
    		if ("line2" in $$props) $$invalidate(10, line2 = $$props.line2);
    		if ("yLabels" in $$props) $$invalidate(11, yLabels = $$props.yLabels);
    		if ("yLabels2" in $$props) $$invalidate(12, yLabels2 = $$props.yLabels2);
    		if ("yLabels3" in $$props) yLabels3 = $$props.yLabels3;
    		if ("Territory" in $$props) $$invalidate(13, Territory = $$props.Territory);
    		if ("CartPriceInCP" in $$props) $$invalidate(14, CartPriceInCP = $$props.CartPriceInCP);
    		if ("AccountNum" in $$props) $$invalidate(15, AccountNum = $$props.AccountNum);
    		if ("Area" in $$props) $$invalidate(16, Area = $$props.Area);
    		if ("Product" in $$props) $$invalidate(17, Product = $$props.Product);
    		if ("Quantities" in $$props) Quantities = $$props.Quantities;
    	};

    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*data, selectedIso*/ 12) {
    			 if (data && selectedIso) $$invalidate(4, dataArr = data.find(d => d.Territory === selectedIso).dataArr.filter(d => !isNaN(d.value)));
    		}

    		if ($$self.$$.dirty[0] & /*data, selectedIso*/ 12) {
    			 if (data && selectedIso) $$invalidate(5, dataArr2 = data.find(d => d.Territory === selectedIso).dataArr2.filter(d => !isNaN(d.value)));
    		}

    		if ($$self.$$.dirty[0] & /*data, dataArr, radius*/ 262164) {
    			 if (data && dataArr) updateScalesAndGenerators(radius);
    		}

    		if ($$self.$$.dirty[0] & /*data, dataArr2, radius*/ 262180) {
    ...
    class CentralLineChart extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*width*/ ctx[0] === undefined && !("width" in props)) {
    			console_1$2.warn("<CentralLineChart> was created without expected prop 'width'");
    		}

    		if (/*height*/ ctx[1] === undefined && !("height" in props)) {
    			console_1$2.warn("<CentralLineChart> was created without expected prop 'height'");
    		}

    		if (/*data*/ ctx[2] === undefined && !("data" in props)) {
    			console_1$2.warn("<CentralLineChart> was created without expected prop 'data'");
    		}

    		if (/*selectedIso*/ ctx[3] === undefined && !("selectedIso" in props)) {
    			console_1$2.warn("<CentralLineChart> was created without expected prop 'selectedIso'");
    		}

    		if (/*radius*/ ctx[18] === undefined && !("radius" in props)) {
    			console_1$2.warn("<CentralLineChart> was created without expected prop 'radius'");
    		}
    	}
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			g = svg_element("g");
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 2 + " " + /*height*/ ctx[1] / 2 + ")");
    			add_location(g, file$7, 66, 0, 2137);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	let { radius } = $$props;
    	let { selectedIso } = $$props;
    	const countryLabelArc = d3arc().startAngle(d => d.angle - Math.PI).endAngle(d => d.angle + Math.PI).innerRadius(d => d.radius).outerRadius(d => d.radius);
    	let container;
    	let model;
    	...
    	function update(selectedIso) {
    		...
    		select(container).selectAll(".country-label-path").data(model).join("path").attr("class", "country-label-path").attr("id", d => `country-label-path-${d.Territory}`).attr("d", countryLabelArc).attr("fill", "none").attr("stroke", "none");

    		select(container).selectAll(".country-label").data(model).join("text").attr("class", "country-label").append("textPath").attr("href", d => `#country-label-path-${d.Territory}`).attr("font-size", "2rem").attr("text-anchor", "middle").attr("startOffset", d => `${d.angle > Math.PI / 2 && d.angle < 1.5 * Math.PI
		? "75%"
		: "25%"}`).attr("fill", "green").text(d => d.Territory);
    	}
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			g = svg_element("g");
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 2 + " " + /*height*/ ctx[1] / 2 + ")");
    			add_location(g, file$8, 96, 0, 3950);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	function update(selectedIso) {
    		...
    		select(container).selectAll(".year-circle").data(modelYears).join(enter => enter.append("circle").attr("class", "year-circle").attr("fill", "orange").attr("opacity", 0.6).attr("cx", 0).attr("cy", 0).attr("r", 0).call(enter => enter.transition().duration(100).attr("cx", d => Math.sin(Math.PI - scCountryAngle(selectedIso)) * scYearRadius(d.year)).attr("cy", d => Math.cos(Math.PI - scCountryAngle(selectedIso)) * scYearRadius(d.year)).attr("r", d => scMortRate(d.value))), update => update.transition().duration(100).attr("cx", d => Math.sin(Math.PI - scCountryAngle(selectedIso)) * scYearRadius(d.year)).attr("cy", d => Math.cos(Math.PI - scCountryAngle(selectedIso)) * scYearRadius(d.year)).attr("r", d => scMortRate(d.value)), exit => exit.transition().duration(100).attr("cx", 0).attr("cy", 0).attr("r", 0).remove());
    		select(container).selectAll(".CartPriceInCP-circle").data(modelCartPriceInCP).join(enter => enter.append("circle").attr("class", `CartPriceInCP-circle ${CartPriceInCP <= 0 ? "decreased" : "increased"}`).attr("cx", 0).attr("cy", 0).attr("r", 0).call(enter => enter.transition().duration(100).attr("cx", d => d.cx).attr("cy", d => d.cy).attr("r", d => d.r)), update => update.attr("class", `CartPriceInCP-circle ${CartPriceInCP <= 0 ? "decreased" : "increased"}`).transition().duration(100).attr("cx", d => d.cx).attr("cy", d => d.cy).attr("r", d => d.r), exit => exit.transition().duration(100).attr("cx", 0).attr("cy", 0).attr("r", 0).remove());
    	}
    	...
    	$$self.$set = $$props => {
    		...
    		if ("scCartPriceInCP" in $$props) $$invalidate(8, scCartPriceInCP = $$props.scCartPriceInCP);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("scCartPriceInCP" in $$props) $$invalidate(8, scCartPriceInCP = $$props.scCartPriceInCP);
    		if ("selectedIso" in $$props) $$invalidate(9, selectedIso = $$props.selectedIso);
    		if ("CartPriceInCP" in $$props) CartPriceInCP = $$props.CartPriceInCP;
    		if ("container" in $$props) $$invalidate(2, container = $$props.container);
    		if ("modelYears" in $$props) modelYears = $$props.modelYears;
    		if ("modelCartPriceInCP" in $$props) modelCartPriceInCP = $$props.modelCartPriceInCP;
    	};
    ...
    class CountryHighlighter extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*scCartPriceInCP*/ ctx[8] === undefined && !("scCartPriceInCP" in props)) {
    			console.warn("<CountryHighlighter> was created without expected prop 'scCartPriceInCP'");
    		}
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$9, 23, 2, 666);
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*width*/ ctx[0] / 2 + " " + /*height*/ ctx[1] / 2 + ")");
    			add_location(g, file$9, 22, 0, 612);
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	function detectIso(e) {
    		...
    		const Territory = scCountryAngle.domain()[bisectRight(scCountryAngle.range(), angle) - 1];
    ...
    function create_fragment$a(ctx) {
    	...
    	const isodetector = new IsoDetector({
    			props: {
    				width: /*width*/ ctx[0],
    				height: /*height*/ ctx[1],
    				radius: /*scCartPriceInCP*/ ctx[7].range()[1],
    				scCountryAngle: /*scCountryAngle*/ ctx[5],
    				selectedIso: /*selectedIso*/ ctx[9]
    			},
    			$$inline: true
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(svg, "class", "svg-visual svelte-n394mc");
    			attr_dev(svg, "width", /*width*/ ctx[0]);
    			attr_dev(svg, "height", /*height*/ ctx[1]);
    			set_style(svg, "margin", /*offset*/ ctx[2] / 2 + "px");
    			add_location(svg, file$a, 23, 0, 671);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			const defs_changes = {};
    			if (dirty & /*scCartPriceInCP*/ 128) defs_changes.scCartPriceInCP = /*scCartPriceInCP*/ ctx[7];
    			...
    			if (dirty & /*scCartPriceInCP*/ 128) countryhighlighter_changes.scCartPriceInCP = /*scCartPriceInCP*/ ctx[7];
    			...
    			if (dirty & /*scCartPriceInCP*/ 128) isodetector_changes.radius = /*scCartPriceInCP*/ ctx[7].range()[1];
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*scCartPriceInCP*/ 128) {
    			 $$invalidate(11, countryRadius = scCartPriceInCP.range()[1]);
    		}
    	};
    ...
    class SVGVisualOver extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*scCartPriceInCP*/ ctx[7] === undefined && !("scCartPriceInCP" in props)) {
    			console.warn("<SVGVisualOver> was created without expected prop 'scCartPriceInCP'");
    		}
    ...
    function create_if_block$2(ctx) {
    	...
    	const svgvisualbelow = new SVGVisualBelow({
    			props: {
    				...
    				scCartPriceInCP: /*scCartPriceInCP*/ ctx[9]
    			},
    			$$inline: true
    		});
    	...
    	svgvisualover.$on("isochanged", /*isochanged_handler*/ ctx[18]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*scCartPriceInCP*/ 512) svgvisualbelow_changes.scCartPriceInCP = /*scCartPriceInCP*/ ctx[9];
    			...
    			if (dirty & /*scCartPriceInCP*/ 512) svgvisualover_changes.scCartPriceInCP = /*scCartPriceInCP*/ ctx[9];
    ...
    function create_fragment$b(ctx) {
    	...
    	let current;
    	document.body.addEventListener("click", /*click_handler*/ ctx[17]);
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			if (if_block) if_block.c();
    			attr_dev(div, "class", "wrapper svelte-ywyreb");
    			add_render_callback(() => /*div_elementresize_handler*/ ctx[19].call(div));
    			add_location(div, file$b, 83, 0, 2926);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		d: function destroy(detaching) {
    			document.body.removeEventListener("click", /*click_handler*/ ctx[17]);
    ...
    function instance$b($$self, $$props, $$invalidate) {
    	...
    	function initScales(minDim) {
    		$$invalidate(5, scYearColor = ordinal().domain(years).range(["rgb(252,123,35)", "rgb(253, 203, 71)", "rgb(176, 201, 73)"]));
    		$$invalidate(6, scCountryAngle = ordinal().domain(data.map(d => d.Territory)).range(range(angleOffset, 2 * Math.PI - angleOffset, (2 * Math.PI - 2 * angleOffset) / data.length)));
    		...
    		$$invalidate(9, scCartPriceInCP = linear$1().domain(extent(data.map(d => d.CartPriceInCP))).range([
    			Math.min(scYearRadius(years[years.length - 1]) + CartPriceInCPOffset, minDim / 2 - padding),
    			minDim / 2 - padding
    		]));

    		scDeliveryTimeCost = linear$1().domain(extent(data.map(d => d.DeliveryTimeCost))).range([
    			Math.min(scYearRadius(years[years.length - 1]) + CartPriceInCPOffset, minDim / 2 - padding),
    			minDim / 2 - padding
    		]);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("scMortRate" in $$props) $$invalidate(8, scMortRate = $$props.scMortRate);
    		if ("scCartPriceInCP" in $$props) $$invalidate(9, scCartPriceInCP = $$props.scCartPriceInCP);
    		if ("scDeliveryTimeCost" in $$props) scDeliveryTimeCost = $$props.scDeliveryTimeCost;
    		if ("padding" in $$props) padding = $$props.padding;
    		if ("CartPriceInCPOffset" in $$props) CartPriceInCPOffset = $$props.CartPriceInCPOffset;
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			h1 = element("h1");
    			h1.textContent = "The Sales of Different Area";
    			t1 = space();
    			div1 = element("div");
    			if (if_block) if_block.c();
    			attr_dev(h1, "class", "svelte-12j1qee");
    			add_location(h1, file$c, 64, 4, 1610);
    			attr_dev(div0, "class", "header svelte-12j1qee");
    			add_location(div0, file$c, 63, 2, 1585);
    			attr_dev(div1, "id", "visual");
    			attr_dev(div1, "class", "svelte-12j1qee");
    			add_location(div1, file$c, 66, 2, 1658);
    			attr_dev(div2, "class", "wrapper svelte-12j1qee");
    			add_location(div2, file$c, 62, 0, 1561);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$c($$self, $$props, $$invalidate) {
    	...
    	async function load() {
    		$$invalidate(0, data = await csv$1("deadOrders.csv", d => {
    			const dataArr = [];
    			const dataArr2 = [];

    			const returnObj = {
    				Territory: d.Territory,
    				CartPriceInCP: +d.CartPriceInCP,
    			...
    			for (let key in d) {
    				...
    				if (match) {
    					let year = +match[1];
    					dataArr2.push({ year, value: +d[key] });
    				}
    			}
